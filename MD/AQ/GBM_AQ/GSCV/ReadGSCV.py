...
print()
print("GSCV GBR")
df = pd.read_csv('GSCV_GBR_V4.csv') 
...
list_column = ['param_loss', 'param_learning_rate', 'param_n_estimators', 'param_criterion', 'param_min_samples_split', 'param_subsample', 'param_max_depth', 'param_max_features', 'mean_test_score','std_test_score','rank_test_score']
df_GSCV = df[list_column]
df_GSCV.sort_values(by='rank_test_score', inplace = True)
print(df_GSCV.head(30))
