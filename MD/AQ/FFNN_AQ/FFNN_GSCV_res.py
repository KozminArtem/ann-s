...
for iteration in range(Number_measure):
    ...
    network.compile(loss=loss_func, optimizer= keras.optimizers.Adam(learning_rate = 0.01, decay = 0.001, epsilon = 1e-01), metrics=['mean_squared_error']) 
...
for iteration in range(Number_measure):
    ...
    network.add(layers.Dense(units = 10, activation = activ_func, input_shape=(l_feat,), kernel_regularizer=regularizers.L1(10**(-1))))
    network.add(layers.Dense(units=1, activation = 'linear'))
    network.compile(loss=loss_func, optimizer= keras.optimizers.Adam(learning_rate = 0.05, decay = 0.005, epsilon = 1e-01), metrics=['mean_squared_error']) 
...
print("epochs = 500")
print("learning_rate = 0.05, decay = 0.005, epsilon = 1e-01")
print(MSE_Test.mean(), MSE_Test.min(), MSE_Test.max(), MSE_Test.std())
print(MAPE_Test.mean(), MAPE_Test.min(), MAPE_Test.max(), MAPE_Test.std())
print(GRE_Test.mean(), GRE_Test.min(), GRE_Test.max(), GRE_Test.std())
...
for iteration in range(Number_measure):
    ...
    network.add(layers.Dense(units=1, activation = 'linear'))
    network.compile(loss=loss_func, optimizer= keras.optimizers.Adam(learning_rate = 0.05, decay = 0.005, epsilon = 1e-01), metrics=['mean_squared_error']) 
    history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 100, batch_size = 50)
    # if iteration == Number_measure - 1:
    #     plot_loss(history, string_l = "NN Adam MAE", draw_val = True)
...
for iteration in range(Number_measure):
    ...
    network.add(layers.Dense(units = 10, activation = activ_func, input_shape=(l_feat,), kernel_regularizer=regularizers.L1(10**(-1))))
    network.add(layers.Dense(units=1, activation = 'linear'))
    network.compile(loss=loss_func, optimizer= keras.optimizers.Adam(learning_rate = 0.05, decay = 0.005, epsilon = 1e-07), metrics=['mean_squared_error']) 
    history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 1000, batch_size = 50)
    # if iteration == Number_measure - 1:
    #     plot_loss(history, string_l = "NN Adam MAE", draw_val = True)
...
print("epochs = 1000")
print("learning_rate = 0.05, decay = 0.005, epsilon = 1e-07")
print(MSE_Test.mean(), MSE_Test.min(), MSE_Test.max(), MSE_Test.std())
print(MAPE_Test.mean(), MAPE_Test.min(), MAPE_Test.max(), MAPE_Test.std())
print(GRE_Test.mean(), GRE_Test.min(), GRE_Test.max(), GRE_Test.std())
...
for iteration in range(Number_measure):
    ...
    network.add(layers.Dense(units = 10, activation = activ_func, input_shape=(l_feat,), kernel_regularizer=regularizers.L1(10**(-1))))
    network.add(layers.Dense(units=1, activation = 'linear'))
    network.compile(loss=loss_func, optimizer= keras.optimizers.Adam(learning_rate = 0.01, decay = 0.001, epsilon = 1e-07), metrics=['mean_squared_error']) 
    history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 1000, batch_size = 50)
    # if iteration == Number_measure - 1:
    #     plot_loss(history, string_l = "NN Adam MAE", draw_val = True)
...
print("epochs = 1000")
print("learning_rate = 0.01, decay = 0.001, epsilon = 1e-07")
print(MSE_Test.mean(), MSE_Test.min(), MSE_Test.max(), MSE_Test.std())
print(MAPE_Test.mean(), MAPE_Test.min(), MAPE_Test.max(), MAPE_Test.std())
print(GRE_Test.mean(), GRE_Test.min(), GRE_Test.max(), GRE_Test.std())
