...
List_Neur = range(1,23,3)

List_MSE_Train_Min = np.array([np.NaN] * len(List_Neur)) 
List_MSE_Train_Max = np.array([np.NaN] * len(List_Neur)) 
List_MSE_Train_Mean = np.array([np.NaN] * len(List_Neur)) 
List_MAPE_Train_Min = np.array([np.NaN] * len(List_Neur)) 
List_MAPE_Train_Max = np.array([np.NaN] * len(List_Neur)) 
List_MAPE_Train_Mean = np.array([np.NaN] * len(List_Neur)) 


List_MSE_Test_Min = np.array([np.NaN] * len(List_Neur)) 
List_MSE_Test_Max = np.array([np.NaN] * len(List_Neur)) 
List_MSE_Test_Mean = np.array([np.NaN] * len(List_Neur)) 
List_MAPE_Test_Min = np.array([np.NaN] * len(List_Neur)) 
List_MAPE_Test_Max = np.array([np.NaN] * len(List_Neur)) 
List_MAPE_Test_Mean = np.array([np.NaN] * len(List_Neur)) 
...
for count, neur in enumerate(List_Neur):
    for iteration in range(Number_measure):
        ...
        network.add(layers.Dense(units = neur, activation = activ_func, input_shape=(l_feat,)))
        ...
        history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 100,batch_size = 50, validation_split = 0.1)
    ...
    print(count, neur, MAPE_Test.min(), MAPE_Test.mean())


figure, axis = plt.subplots(1,2) 
axis[0].plot(List_Neur, List_MSE_Train_Min, label="Train_min", linewidth=1.0, color = "red")
axis[0].plot(List_Neur, List_MSE_Train_Max, label="Train_max", linewidth=1.0, color = "red")
axis[0].plot(List_Neur, List_MSE_Train_Mean, label="Train_mean", linewidth=2.0, color = "red")
axis[0].plot(List_Neur, List_MSE_Test_Min, label="Test_min", linewidth=1.0, color = "green")
axis[0].plot(List_Neur, List_MSE_Test_Max, label="Test_max", linewidth=1.0, color = "green")
axis[0].plot(List_Neur, List_MSE_Test_Mean, label="Test_mean", linewidth=2.0, color = "green")
axis[0].set_title("MSE, Hidden_Tanh, non_regul")
axis[0].legend(loc="best")



axis[1].plot(List_Neur, List_MAPE_Train_Min, label="Train_min", linewidth=1.0, color = "red")
axis[1].plot(List_Neur, List_MAPE_Train_Max, label="Train_max", linewidth=1.0, color = "red")
axis[1].plot(List_Neur, List_MAPE_Train_Mean, label="Train_mean", linewidth=2.0, color = "red")
axis[1].plot(List_Neur, List_MAPE_Test_Min, label="Test_min", linewidth=1.0, color = "green")
axis[1].plot(List_Neur, List_MAPE_Test_Max, label="Test_max", linewidth=1.0, color = "green")
axis[1].plot(List_Neur, List_MAPE_Test_Mean, label="Test_mean", linewidth=2.0, color = "green")
axis[1].set_title("MAPE Hidden_Tanh, non_regul")
...
for count, neur in enumerate(List_Neur):
    for iteration in range(Number_measure):
        ...
        l_feat = X_train_scaled_poly.shape[1]
        # print(iteration, l_feat)
        network.add(layers.Dense(units = neur, activation = activ_func, input_shape=(l_feat,), kernel_regularizer='l1'))
        network.add(layers.Dense(units=1, activation = 'linear'))
        network.compile(loss=loss_func, optimizer= keras.optimizers.Adam(0.005), metrics=['mean_squared_error']) 
        history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 100,batch_size = 50, validation_split = 0.1)
        if iteration == Number_measure - 1:
...
figure, axis = plt.subplots(1,2) 
axis[0].plot(List_Neur, List_MSE_Train_Min, linewidth=0.75, color = "red")
axis[0].plot(List_Neur, List_MSE_Train_Max, linewidth=0.75, color = "red")
axis[0].plot(List_Neur, List_MSE_Train_Mean, label="Train_mean", linewidth=2.0, color = "red")

axis[0].plot(List_Neur, List_MSE_non_Min, linewidth=0.75, color = "black")
axis[0].plot(List_Neur, List_MSE_non_Max, linewidth=0.75, color = "black")
axis[0].plot(List_Neur, List_MSE_non_Mean, label="NonReg_mean", linewidth=2.0, color = "black")

axis[0].plot(List_Neur, List_MSE_Test_Min, linewidth=0.75, color = "green")
axis[0].plot(List_Neur, List_MSE_Test_Max, linewidth=0.75, color = "green")
axis[0].plot(List_Neur, List_MSE_Test_Mean, label="Test_Reg_mean", linewidth=2.0, color = "green")

axis[0].set_title("MSE, Hidden_Tanh, L1_regul 0.01")
axis[0].legend(loc="best")



axis[1].plot(List_Neur, List_MAPE_Train_Min, linewidth=0.75, color = "red")
axis[1].plot(List_Neur, List_MAPE_Train_Max, linewidth=0.75, color = "red")
axis[1].plot(List_Neur, List_MAPE_Train_Mean, label="Train_mean", linewidth=2.0, color = "red")


axis[1].plot(List_Neur, List_MAPE_non_Min, linewidth=0.75, color = "black")
axis[1].plot(List_Neur, List_MAPE_non_Max, linewidth=0.75, color = "black")
axis[1].plot(List_Neur, List_MAPE_non_Mean, label="NonReg_mean", linewidth=2.0, color = "black")

axis[1].plot(List_Neur, List_MAPE_Test_Min, linewidth=0.75, color = "green")
axis[1].plot(List_Neur, List_MAPE_Test_Max, linewidth=0.75, color = "green")
axis[1].plot(List_Neur, List_MAPE_Test_Mean, label="Test_Reg_mean", linewidth=2.0, color = "green")

axis[1].set_title("MAPE, Hidden_Tanh, L1_regul 0.01")
axis[1].legend(loc="best")
...
for count, neur in enumerate(List_Neur):
    for iteration in range(Number_measure):
        ...
        l_feat = X_train_scaled_poly.shape[1]
        # print(iteration, l_feat)
        network.add(layers.Dense(units = neur, activation = activ_func, input_shape=(l_feat,), kernel_regularizer='l2'))
        network.add(layers.Dense(units=1, activation = 'linear'))
        network.compile(loss=loss_func, optimizer= keras.optimizers.Adam(0.005), metrics=['mean_squared_error']) 
        history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 100,batch_size = 50, validation_split = 0.1)
        if iteration == Number_measure - 1:
...
axis[0].set_title("MSE, Hidden_Tanh, L2_regul 0.01")
axis[0].legend(loc="best")
...
axis[1].set_title("MAPE, Hidden_Tanh, L2_regul 0.01")
axis[1].legend(loc="best")
