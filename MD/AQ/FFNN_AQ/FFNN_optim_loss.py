...
# l_feat = X_train_scaled_poly.shape[1]
# network.add(layers.Dense(units = 1, activation = 'linear', input_shape=(l_feat,)))
# network.compile(loss='mean_squared_error', optimizer= keras.optimizers.Adam(0.01, decay = 1e-6), metrics=['mean_squared_error']) 
# history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 500, validation_split = 0)
# plot_loss(history, string_l = "NN(ML) Adam 0.01, decay 1e-6")
# plotModelResults(network, X_train=X_train_scaled_poly, X_test=X_test_scaled_poly, string = "NN(ML) Adam 0.01, decay 1e-6",  plot_intervals=True,\
#                  y_train = y_train, y_test = y_test, time_train = time_train, time_test = time_test, plot_diff = False)
# keras.backend.clear_session()
...
# l_feat = X_train_scaled_poly.shape[1]
# network.add(layers.Dense(units = 1, activation = 'linear', input_shape=(l_feat,)))
# network.compile(loss='mean_squared_error', optimizer= keras.optimizers.Adam(0.005, amsgrad = True), metrics=['mean_squared_error']) 
# history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 500, validation_split = 0)
# plot_loss(history, string_l = "NN(ML) Adam 0.005, amsgrad")
# plotModelResults(network, X_train=X_train_scaled_poly, X_test=X_test_scaled_poly, string = "NN(ML) Adam 0.005, amsgrad",  plot_intervals=True,\
#                  y_train = y_train, y_test = y_test, time_train = time_train, time_test = time_test, plot_diff = False)
# keras.backend.clear_session()
...
# l_feat = X_train_scaled_poly.shape[1]
# network.add(layers.Dense(units = 1, activation = 'linear', input_shape=(l_feat,)))
# network.compile(loss='mean_squared_error', optimizer= keras.optimizers.Nadam(0.005), metrics=['mean_squared_error']) 
# history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 500, validation_split = 0)
# plot_loss(history, string_l = "NN(ML) Nadam 0.005")
# plotModelResults(network, X_train=X_train_scaled_poly, X_test=X_test_scaled_poly, string = "NN(ML) Nadam 0.005",  plot_intervals=True,\
#                  y_train = y_train, y_test = y_test, time_train = time_train, time_test = time_test, plot_diff = False)
# keras.backend.clear_session()
...
# l_feat = X_train_scaled_poly.shape[1]
# network.add(layers.Dense(units = 1, activation = 'linear', input_shape=(l_feat,)))
# network.compile(loss='mean_squared_error', optimizer= keras.optimizers.Adadelta(learning_rate = 0.1, rho = 0.95), metrics=['mean_squared_error']) 
# history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 1000, validation_split = 0)
# plot_loss(history, string_l = "NN(ML) Adadelta 0.1, rho = 0.95")
# plotModelResults(network, X_train=X_train_scaled_poly, X_test=X_test_scaled_poly, string = "NN(ML) Adadelta 0.1, rho = 0.95",  plot_intervals=True,\
#                  y_train = y_train, y_test = y_test, time_train = time_train, time_test = time_test, plot_diff = False)
# keras.backend.clear_session()
...
# l_feat = X_train_scaled_poly.shape[1]
# network.add(layers.Dense(units = 1, activation = 'linear', input_shape=(l_feat,)))
# network.compile(loss='mean_squared_error', optimizer= keras.optimizers.Adadelta(learning_rate = 0.01, rho = 0.95), metrics=['mean_squared_error']) 
# history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 1000, validation_split = 0)
# plot_loss(history, string_l = "NN(ML) Adadelta 0.01, rho = 0.95")
# plotModelResults(network, X_train=X_train_scaled_poly, X_test=X_test_scaled_poly, string = "NN(ML) Adadelta 0.01, rho = 0.95",  plot_intervals=True,\
#                  y_train = y_train, y_test = y_test, time_train = time_train, time_test = time_test, plot_diff = False)
# keras.backend.clear_session()
...
# l_feat = X_train_scaled_poly.shape[1]
# network.add(layers.Dense(units = 1, activation = 'linear', input_shape=(l_feat,)))
# network.compile(loss='mean_squared_error', optimizer= keras.optimizers.Adadelta(learning_rate = 0.01, rho = 0.5), metrics=['mean_squared_error']) 
# history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 1000, validation_split = 0)
# plot_loss(history, string_l = "NN(ML) Adadelta 0.01, rho = 0.5")
# plotModelResults(network, X_train=X_train_scaled_poly, X_test=X_test_scaled_poly, string = "NN(ML) Adadelta 0.01, rho = 0.5",  plot_intervals=True,\
#                  y_train = y_train, y_test = y_test, time_train = time_train, time_test = time_test, plot_diff = False)
# keras.backend.clear_session()
...
# l_feat = X_train_scaled_poly.shape[1]
# network.add(layers.Dense(units = 1, activation = 'linear', input_shape=(l_feat,)))
# network.compile(loss='mean_squared_error', optimizer= keras.optimizers.Adadelta(learning_rate = 0.001, rho = 0.95), metrics=['mean_squared_error']) 
# history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 1000, validation_split = 0)
# plot_loss(history, string_l = "NN(ML) Adadelta 0.001, rho = 0.95")
# plotModelResults(network, X_train=X_train_scaled_poly, X_test=X_test_scaled_poly, string = "NN(ML) Adadelta 0.001, rho = 0.95",  plot_intervals=True,\
#                  y_train = y_train, y_test = y_test, time_train = time_train, time_test = time_test, plot_diff = False)
# keras.backend.clear_session()
...
# history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 500, validation_split = 0)
# plot_loss(history, string_l = "NN(ML) SGD 0.01")
# plotModelResults(network, X_train=X_train_scaled_poly, X_test=X_test_scaled_poly, string = "NN(ML) SGD 0.01",  plot_intervals=True,\
#                  y_train = y_train, y_test = y_test, time_train = time_train, time_test = time_test, plot_diff = False)
# keras.backend.clear_session()
...
# network.compile(loss='mean_squared_error', optimizer= sgd, metrics=['mean_squared_error']) 
# history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 500, validation_split = 0)
# plot_loss(history, string_l = "NN(ML) SGD 0.001")
# plotModelResults(network, X_train=X_train_scaled_poly, X_test=X_test_scaled_poly, string = "NN(ML) SGD 0.001",  plot_intervals=True,\
#                  y_train = y_train, y_test = y_test, time_train = time_train, time_test = time_test, plot_diff = False)
# keras.backend.clear_session()
...
# network.compile(loss='mean_squared_error', optimizer= sgd, metrics=['mean_squared_error']) 
# history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 500, validation_split = 0)
# plot_loss(history, string_l = "NN(ML) SGD 0.0001")
# plotModelResults(network, X_train=X_train_scaled_poly, X_test=X_test_scaled_poly, string = "NN(ML) SGD 0.0001",  plot_intervals=True,\
#                  y_train = y_train, y_test = y_test, time_train = time_train, time_test = time_test, plot_diff = False)
# keras.backend.clear_session()
...
# network.compile(loss='mean_squared_error', optimizer= sgd, metrics=['mean_squared_error']) 
# history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 500, validation_split = 0)
# plot_loss(history, string_l = "NN(ML) SGD 0.01, momentum = 0.8")
# plotModelResults(network, X_train=X_train_scaled_poly, X_test=X_test_scaled_poly, string = "NN(ML) SGD 0.01, momentum = 0.8",  plot_intervals=True,\
#                  y_train = y_train, y_test = y_test, time_train = time_train, time_test = time_test, plot_diff = False)
# keras.backend.clear_session()
...
# network.compile(loss='mean_squared_error', optimizer= sgd, metrics=['mean_squared_error']) 
# history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 500, validation_split = 0)
# plot_loss(history, string_l = "NN(ML) SGD 0.01, momentum = 0.8, N")
# plotModelResults(network, X_train=X_train_scaled_poly, X_test=X_test_scaled_poly, string = "NN(ML) SGD 0.01, momentum = 0.8, N",  plot_intervals=True,\
#                  y_train = y_train, y_test = y_test, time_train = time_train, time_test = time_test, plot_diff = False)
# keras.backend.clear_session()

# network = models.Sequential()
# l_feat = X_train_scaled_poly.shape[1]
# sgd = keras.optimizers.SGD(learning_rate = 0.01, decay = 1e-4, momentum = 0.8, nesterov = True)
# network.add(layers.Dense(units = 1, activation = 'linear', input_shape=(l_feat,)))
# network.compile(loss='mean_squared_error', optimizer= sgd, metrics=['mean_squared_error']) 
# history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = 500, validation_split = 0)
# plot_loss(history, string_l = "NN(ML) SGD 0.01, momentum = 0.8, N")
