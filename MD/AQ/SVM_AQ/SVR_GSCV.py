...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 1.0, epsilon = 0.001)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 1.0, epsilon = 0.001")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 1.0, epsilon = 0.001)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'scale', C = 1.0, epsilon = 0.001")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))
...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 1.0, epsilon = 0.003)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 1.0, epsilon = 0.003")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 1.0, epsilon = 0.003)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'scale', C = 1.0, epsilon = 0.003")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))
...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 1.0, epsilon = 0.005)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 1.0, epsilon = 0.005")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 1.0, epsilon = 0.005)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'scale', C = 1.0, epsilon = 0.005")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))
...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 1.0, epsilon = 0.1)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 1.0, epsilon = 0.1")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 1.0, epsilon = 0.1)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 1.0, epsilon = 0.2)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 1.0, epsilon = 0.2")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 1.0, epsilon = 0.2)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'scale', C = 1.0, epsilon = 0.2")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))
...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 4.0, epsilon = 0.001)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 4.0, epsilon = 0.001")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 4.0, epsilon = 0.001)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'scale', C = 4.0, epsilon = 0.001")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))
...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 4.0, epsilon = 0.003)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 4.0, epsilon = 0.003")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 4.0, epsilon = 0.003)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'scale', C = 4.0, epsilon = 0.003")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))
...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 4.0, epsilon = 0.005)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 4.0, epsilon = 0.005")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 4.0, epsilon = 0.005)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'scale', C = 4.0, epsilon = 0.005")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))
...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 4.0, epsilon = 0.1)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 4.0, epsilon = 0.1")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 4.0, epsilon = 0.1)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'scale', C = 4.0, epsilon = 0.1")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))
...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 4.0, epsilon = 0.2)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 4.0, epsilon = 0.2")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 4.0, epsilon = 0.2)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'scale', C = 4.0, epsilon = 0.2")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))
...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 0.5, epsilon = 0.001)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 0.5, epsilon = 0.001")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 0.5, epsilon = 0.001)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'scale', C = 0.5, epsilon = 0.001")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))
...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 0.5, epsilon = 0.003)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 0.5, epsilon = 0.003")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 0.5, epsilon = 0.003)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'scale', C = 0.5, epsilon = 0.003")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))
...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 0.5, epsilon = 0.005)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 0.5, epsilon = 0.005")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 0.5, epsilon = 0.005)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'scale', C = 0.5, epsilon = 0.005")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))
...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 0.5, epsilon = 0.1)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 0.5, epsilon = 0.1")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 0.5, epsilon = 0.1)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'scale', C = 0.5, epsilon = 0.1")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))
...
SVRegression = SVR(kernel = 'rbf', gamma = 'auto', C = 0.5, epsilon = 0.2)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'auto', C = 0.5, epsilon = 0.2")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))

SVRegression = SVR(kernel = 'rbf', gamma = 'scale', C = 0.5, epsilon = 0.2)
SVRegression.fit(X_train_scaled_poly, y_train)
y_pred = SVRegression.predict(X_test_scaled_poly)
print("\nSVR kernel = 'rbf', gamma = 'scale', C = 0.5, epsilon = 0.2")
print(mean_s_error(y_test, y_pred))
print(mean_absolute_percentage_error(y_test, y_pred))
print(gate_rate_error(y_test, y_pred))
...
# df_result.to_csv("GSCV/GSCV_SVR_V2.csv", index=True)
