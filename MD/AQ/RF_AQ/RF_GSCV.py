...
for n_est in range(100,301,50):
    RF = RandomForestRegressor(n_estimators = n_est, criterion = 'absolute_error', max_features = 2, max_depth=10, min_samples_split = 4, n_jobs = -1)
    RF.fit(X_train_scaled_poly, y_train)
    y_pred = RF.predict(X_test_scaled_poly)
    print("Random Forest, n_est: " + str(n_est) + "max_depth=10, min_samples_split = 4")
    print(mean_absolute_percentage_error(y_test, y_pred))
    print(mean_s_error(y_test, y_pred))
    print(gate_rate_error(y_test, y_pred))
...
for n_est in range(100,301,50):
    RF = RandomForestRegressor(n_estimators = n_est, criterion = 'absolute_error', max_features = 2, max_depth=20, min_samples_split = 4, n_jobs = -1)
    RF.fit(X_train_scaled_poly, y_train)
    y_pred = RF.predict(X_test_scaled_poly)
    print("Random Forest, n_est: " + str(n_est) + "max_depth=20, min_samples_split = 4")
    print(mean_absolute_percentage_error(y_test, y_pred))
    print(mean_s_error(y_test, y_pred))
    print(gate_rate_error(y_test, y_pred))
...
for n_est in range(100,301,50):
    RF = RandomForestRegressor(n_estimators = n_est, criterion = 'absolute_error', max_features = 2, max_depth=30, min_samples_split = 4, n_jobs = -1)
    RF.fit(X_train_scaled_poly, y_train)
    y_pred = RF.predict(X_test_scaled_poly)
    print("Random Forest, n_est: " + str(n_est) + "max_depth=30, min_samples_split = 4")
    print(mean_absolute_percentage_error(y_test, y_pred))
    print(mean_s_error(y_test, y_pred))
    print(gate_rate_error(y_test, y_pred))
...
for n_est in range(100,301,50):
    RF = RandomForestRegressor(n_estimators = n_est, criterion = 'absolute_error', max_features = 2, max_depth=10, min_samples_split = 8, n_jobs = -1)
    RF.fit(X_train_scaled_poly, y_train)
    y_pred = RF.predict(X_test_scaled_poly)
    print("Random Forest, n_est: " + str(n_est) + "max_depth=10, min_samples_split = 8")
    print(mean_absolute_percentage_error(y_test, y_pred))
    print(mean_s_error(y_test, y_pred))
    print(gate_rate_error(y_test, y_pred))
...
for n_est in range(100,301,50):
    RF = RandomForestRegressor(n_estimators = n_est, criterion = 'absolute_error', max_features = 2, max_depth=20, min_samples_split = 8, n_jobs = -1)
    RF.fit(X_train_scaled_poly, y_train)
    y_pred = RF.predict(X_test_scaled_poly)
    print("Random Forest, n_est: " + str(n_est) + "max_depth=20, min_samples_split = 8")
    print(mean_absolute_percentage_error(y_test, y_pred))
    print(mean_s_error(y_test, y_pred))
    print(gate_rate_error(y_test, y_pred))
...
for n_est in range(100,301,50):
    RF = RandomForestRegressor(n_estimators = n_est, criterion = 'absolute_error', max_features = 2, max_depth=30, min_samples_split = 8, n_jobs = -1)
    RF.fit(X_train_scaled_poly, y_train)
    y_pred = RF.predict(X_test_scaled_poly)
    print("Random Forest, n_est: " + str(n_est) + "max_depth=30, min_samples_split = 8")
    print(mean_absolute_percentage_error(y_test, y_pred))
    print(mean_s_error(y_test, y_pred))
    print(gate_rate_error(y_test, y_pred))
...
for n_est in range(100,301,50):
    RF = RandomForestRegressor(n_estimators = n_est, criterion = 'absolute_error', max_features = 2, max_depth=10, min_samples_split = 16, n_jobs = -1)
    RF.fit(X_train_scaled_poly, y_train)
    y_pred = RF.predict(X_test_scaled_poly)
    print("Random Forest, n_est: " + str(n_est) + "max_depth=10, min_samples_split = 16")
    print(mean_absolute_percentage_error(y_test, y_pred))
    print(mean_s_error(y_test, y_pred))
    print(gate_rate_error(y_test, y_pred))
...
for n_est in range(100,301,50):
    RF = RandomForestRegressor(n_estimators = n_est, criterion = 'absolute_error', max_features = 2, max_depth=20, min_samples_split = 16, n_jobs = -1)
    RF.fit(X_train_scaled_poly, y_train)
    y_pred = RF.predict(X_test_scaled_poly)
    print("Random Forest, n_est: " + str(n_est) + "max_depth=20, min_samples_split = 16")
    print(mean_absolute_percentage_error(y_test, y_pred))
    print(mean_s_error(y_test, y_pred))
    print(gate_rate_error(y_test, y_pred))
...
for n_est in range(100,301,50):
    RF = RandomForestRegressor(n_estimators = n_est, criterion = 'absolute_error', max_features = 2, max_depth=30, min_samples_split = 16, n_jobs = -1)
    RF.fit(X_train_scaled_poly, y_train)
    y_pred = RF.predict(X_test_scaled_poly)
    print("Random Forest, n_est: " + str(n_est) + "max_depth=30, min_samples_split = 16")
    print(mean_absolute_percentage_error(y_test, y_pred))
    print(mean_s_error(y_test, y_pred))
    print(gate_rate_error(y_test, y_pred))
...
for n_est in range(100,301,50):
    RF = RandomForestRegressor(n_estimators = n_est, criterion = 'absolute_error', max_features = 2, max_depth=10, min_samples_split = 32, n_jobs = -1)
    RF.fit(X_train_scaled_poly, y_train)
    y_pred = RF.predict(X_test_scaled_poly)
    print("Random Forest, n_est: " + str(n_est) + "max_depth=10, min_samples_split = 32")
    print(mean_absolute_percentage_error(y_test, y_pred))
    print(mean_s_error(y_test, y_pred))
    print(gate_rate_error(y_test, y_pred))
...
for n_est in range(100,301,50):
    RF = RandomForestRegressor(n_estimators = n_est, criterion = 'absolute_error', max_features = 2, max_depth=20, min_samples_split = 32, n_jobs = -1)
    RF.fit(X_train_scaled_poly, y_train)
    y_pred = RF.predict(X_test_scaled_poly)
    print("Random Forest, n_est: " + str(n_est) + "max_depth=20, min_samples_split = 32")
    print(mean_absolute_percentage_error(y_test, y_pred))
    print(mean_s_error(y_test, y_pred))
    print(gate_rate_error(y_test, y_pred))
...
for n_est in range(100,301,50):
    RF = RandomForestRegressor(n_estimators = n_est, criterion = 'absolute_error', max_features = 2, max_depth=30, min_samples_split = 32, n_jobs = -1)
    RF.fit(X_train_scaled_poly, y_train)
    y_pred = RF.predict(X_test_scaled_poly)
    print("Random Forest, n_est: " + str(n_est) + "max_depth=30, min_samples_split = 32")
    print(mean_absolute_percentage_error(y_test, y_pred))
    print(mean_s_error(y_test, y_pred))
    print(gate_rate_error(y_test, y_pred))
...
#               'max_depth': [12, 16, 20, 24, 28, 32, 36],
#               'min_samples_split': [8,12,16,20,24]
#               # 'max_features': [1,2,3,4]
#                 }

# grid =  GridSearchCV(estimator = RandomForestRegressor(criterion = 'absolute_error', max_features = 2),
...
# df_result.to_csv("GSCV/GSCV_RF_V3.csv", index=True)
