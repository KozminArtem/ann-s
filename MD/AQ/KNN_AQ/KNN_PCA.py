...
# for j in range(1,22):
#     neigh = KNeighborsRegressor(n_neighbors=j, weights = 'distance', p = 1,  n_jobs = -1)
#     neigh.fit(X_train_scaled_poly, y_train)
#     y_pred = neigh.predict(X_test_scaled_poly)
#     print("p = 1, neighbors" + str(j))
...
# df_result.to_csv("GSCV/GSCV_KNN_V1.csv", index=True)
...
max_neig = 30
MAPE = np.array([np.NaN] * max_neig)

for n_comp in range(1, X_train_scaled_poly.shape[1] + 1):
    ...
    for j in range(1,max_neig+1):
        neigh = KNeighborsRegressor(n_neighbors=j, weights = 'distance', p = 1,  n_jobs = -1)
        neigh.fit(X_train_PCA, y_train)
        y_pred = neigh.predict(X_test_PCA)
        # print("p = 1, neighbors " + str(j) + ", PCA: " + str(n_comp))
        # print(mean_absolute_percentage_error(y_test, y_pred))
        # print(mean_s_error(y_test, y_pred))
        # print(gate_rate_error(y_test, y_pred))
        MAPE[j-1] = mean_absolute_percentage_error(y_test, y_pred)  
    print(MAPE.min())


    for j in range(1,max_neig+1):
        neigh = KNeighborsRegressor(n_neighbors=j, weights = 'distance', p = 2,  n_jobs = -1)
        neigh.fit(X_train_PCA, y_train)
        y_pred = neigh.predict(X_test_PCA)
        # print("p = 2, neighbors " + str(j) + ", PCA: " + str(n_comp))
        # print(mean_absolute_percentage_error(y_test, y_pred))
        # print(mean_s_error(y_test, y_pred))
        # print(gate_rate_error(y_test, y_pred))
        MAPE[j-1] = mean_absolute_percentage_error(y_test, y_pred)  
    ...
    for j in range(1,max_neig+1):
        neigh = KNeighborsRegressor(n_neighbors=j, weights = 'distance', p = 3,  n_jobs = -1)
        neigh.fit(X_train_PCA, y_train)
        y_pred = neigh.predict(X_test_PCA)
        # print("p = 2, neighbors " + str(j) + ", PCA: " + str(n_comp))
        # print(mean_absolute_percentage_error(y_test, y_pred))
    ...
    if n_comp == X_train_scaled_poly.shape[1]:
...
for n_comp in range(1, X_train_scaled_poly.shape[1] + 1):
    ...
    for j in range(1,max_neig+1):
        neigh = KNeighborsRegressor(n_neighbors=j, weights = 'distance', p = 1,  n_jobs = -1)
        neigh.fit(X_train_FA, y_train)
        y_pred = neigh.predict(X_test_FA)
        # print("p = 1, neighbors " + str(j) + ", FA: " + str(n_comp))
        # print(mean_absolute_percentage_error(y_test, y_pred))
        # print(mean_s_error(y_test, y_pred))
        # print(gate_rate_error(y_test, y_pred))
        MAPE[j-1] = mean_absolute_percentage_error(y_test, y_pred)  
    ...
    for j in range(1,max_neig+1):
        ...
        neigh.fit(X_train_FA, y_train)
        y_pred = neigh.predict(X_test_FA)
        # print("p = 2, neighbors " + str(j) + ", FA: " + str(n_comp))
        # print(mean_absolute_percentage_error(y_test, y_pred))
        # print(mean_s_error(y_test, y_pred))
        # print(gate_rate_error(y_test, y_pred))
        MAPE[j-1] = mean_absolute_percentage_error(y_test, y_pred)  
