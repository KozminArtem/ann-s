...
def network_model(l_r = 0.01, d_c = 0.01, b_1 = 0.9, b_2 = 0.999, eps = 1e-07, reg = -1, activ = 'tanh'):
    network = models.Sequential()
    network.add(layers.Dense(units = 10, activation = activ, input_shape=(l_feat,), kernel_regularizer=regularizers.L1(10**reg)))
...
df_result.to_csv("GSCV/GSCV_1000_V5_ep.csv", index=True)
