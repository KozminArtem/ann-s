...
List_Hidden = [1,2,3,4,5]

List_MSE_Train_Min = np.array([np.NaN] * len(List_Hidden)) 
List_MSE_Train_Max = np.array([np.NaN] * len(List_Hidden)) 
List_MSE_Train_Mean = np.array([np.NaN] * len(List_Hidden)) 
List_MAPE_Train_Min = np.array([np.NaN] * len(List_Hidden)) 
List_MAPE_Train_Max = np.array([np.NaN] * len(List_Hidden)) 
List_MAPE_Train_Mean = np.array([np.NaN] * len(List_Hidden)) 


List_MSE_Test_Min = np.array([np.NaN] * len(List_Hidden)) 
List_MSE_Test_Max = np.array([np.NaN] * len(List_Hidden)) 
List_MSE_Test_Mean = np.array([np.NaN] * len(List_Hidden)) 
List_MAPE_Test_Min = np.array([np.NaN] * len(List_Hidden)) 
List_MAPE_Test_Max = np.array([np.NaN] * len(List_Hidden)) 
List_MAPE_Test_Mean = np.array([np.NaN] * len(List_Hidden)) 
...
for count, hidden in enumerate(List_Hidden):
    for iteration in range(Number_measure):
        network = models.Sequential()
        l_feat = X_train_scaled_poly.shape[1]
        # print(iteration, l_feat)
        network.add(layers.Dense(units = 2**hidden, activation = activ_func, input_shape=(l_feat,)))
        for h in range(1, hidden):
            network.add(layers.Dense(units = 2**(hidden - h), activation = activ_func))   
        ...
        history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = hidden*100,batch_size = 50, validation_split = 0.1)
        if iteration == Number_measure - 1:
            plot_loss(history, string_l = "NN Adam MAE" + str(hidden), draw_val = True)
    ...
    print(count, hidden, MAPE_Test.min(), MAPE_Test.mean())


figure, axis = plt.subplots(1,2) 
axis[0].plot(List_Hidden, List_MSE_Train_Min, label="Train_min", linewidth=1.0, color = "red")
axis[0].plot(List_Hidden, List_MSE_Train_Max, label="Train_max", linewidth=1.0, color = "red")
axis[0].plot(List_Hidden, List_MSE_Train_Mean, label="Train_mean", linewidth=2.0, color = "red")
axis[0].plot(List_Hidden, List_MSE_Test_Min, label="Test_min", linewidth=1.0, color = "green")
axis[0].plot(List_Hidden, List_MSE_Test_Max, label="Test_max", linewidth=1.0, color = "green")
axis[0].plot(List_Hidden, List_MSE_Test_Mean, label="Test_mean", linewidth=2.0, color = "green")
axis[0].set_title("MSE, Hidden_Tanh triangle, non_regul")
axis[0].legend(loc="best")



axis[1].plot(List_Hidden, List_MAPE_Train_Min, label="Train_min", linewidth=1.0, color = "red")
axis[1].plot(List_Hidden, List_MAPE_Train_Max, label="Train_max", linewidth=1.0, color = "red")
axis[1].plot(List_Hidden, List_MAPE_Train_Mean, label="Train_mean", linewidth=2.0, color = "red")
axis[1].plot(List_Hidden, List_MAPE_Test_Min, label="Test_min", linewidth=1.0, color = "green")
axis[1].plot(List_Hidden, List_MAPE_Test_Max, label="Test_max", linewidth=1.0, color = "green")
axis[1].plot(List_Hidden, List_MAPE_Test_Mean, label="Test_mean", linewidth=2.0, color = "green")
axis[1].set_title("MAPE, Hidden_Tanh triangle, non_regul")
...
for count, hidden in enumerate(List_Hidden):
    for iteration in range(Number_measure):
        ...
        l_feat = X_train_scaled_poly.shape[1]
        # print(iteration, l_feat)
        network.add(layers.Dense(units = 2**hidden, activation = activ_func, input_shape=(l_feat,), kernel_regularizer=regularizers.L1(regL1)))
        for h in range(1, hidden):
            network.add(layers.Dense(units = 2**(hidden - h), activation = activ_func, kernel_regularizer=regularizers.L1(regL1)))   
        network.add(layers.Dense(units=1, activation = 'linear'))
        network.compile(loss=loss_func, optimizer= keras.optimizers.Adam(0.005, decay = 0.005), metrics=['mean_squared_error']) 
        history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = hidden * 100,batch_size = 50, validation_split = 0.1)
        if iteration == Number_measure - 1:
...
figure, axis = plt.subplots(1,2) 
axis[0].plot(List_Hidden, List_MSE_Train_Min, linewidth=0.75, color = "red")
axis[0].plot(List_Hidden, List_MSE_Train_Max, linewidth=0.75, color = "red")
axis[0].plot(List_Hidden, List_MSE_Train_Mean, label="Train_mean", linewidth=2.0, color = "red")

axis[0].plot(List_Hidden, List_MSE_non_Min, linewidth=0.75, color = "black")
axis[0].plot(List_Hidden, List_MSE_non_Max, linewidth=0.75, color = "black")
axis[0].plot(List_Hidden, List_MSE_non_Mean, label="NonReg_mean", linewidth=2.0, color = "black")

axis[0].plot(List_Hidden, List_MSE_Test_Min, linewidth=0.75, color = "green")
axis[0].plot(List_Hidden, List_MSE_Test_Max, linewidth=0.75, color = "green")
axis[0].plot(List_Hidden, List_MSE_Test_Mean, label="Test_Reg_mean", linewidth=2.0, color = "green")

axis[0].set_title("MSE, Hidden_Tanh triangle, L1 = 0.1")
axis[0].legend(loc="best")



axis[1].plot(List_Hidden, List_MAPE_Train_Min, linewidth=0.75, color = "red")
axis[1].plot(List_Hidden, List_MAPE_Train_Max, linewidth=0.75, color = "red")
axis[1].plot(List_Hidden, List_MAPE_Train_Mean, label="Train_mean", linewidth=2.0, color = "red")


axis[1].plot(List_Hidden, List_MAPE_non_Min, linewidth=0.75, color = "black")
axis[1].plot(List_Hidden, List_MAPE_non_Max, linewidth=0.75, color = "black")
axis[1].plot(List_Hidden, List_MAPE_non_Mean, label="NonReg_mean", linewidth=2.0, color = "black")

axis[1].plot(List_Hidden, List_MAPE_Test_Min, linewidth=0.75, color = "green")
axis[1].plot(List_Hidden, List_MAPE_Test_Max, linewidth=0.75, color = "green")
axis[1].plot(List_Hidden, List_MAPE_Test_Mean, label="Test_Reg_mean", linewidth=2.0, color = "green")

axis[1].set_title("MAPE, Hidden_Tanh triangle, L1 = 0.1")
axis[1].legend(loc="best")
...
for count, hidden in enumerate(List_Hidden):
    for iteration in range(Number_measure):
        ...
        l_feat = X_train_scaled_poly.shape[1]
        # print(iteration, l_feat)
        network.add(layers.Dense(units = 2**hidden, activation = activ_func, input_shape=(l_feat,), kernel_regularizer=regularizers.L2(regL2)))
        for h in range(1, hidden):
            network.add(layers.Dense(units = 2**(hidden - h), activation = activ_func, kernel_regularizer=regularizers.L2(regL2)))   
        network.add(layers.Dense(units=1, activation = 'linear'))
        network.compile(loss=loss_func, optimizer= keras.optimizers.Adam(0.005, decay = 0.005), metrics=['mean_squared_error']) 
        history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = hidden * 100,batch_size = 50, validation_split = 0.1)
        if iteration == Number_measure - 1:
...
axis[0].set_title("MSE, Hidden_Tanh triangle, L2 = 0.003")
axis[0].legend(loc="best")
...
axis[1].set_title("MAPE, Hidden_Tanh triangle, L2 = 0.003")
axis[1].legend(loc="best")
...
for count, hidden in enumerate(List_Hidden):
    for iteration in range(Number_measure):
        ...
        l_feat = X_train_scaled_poly.shape[1]
        # print(iteration, l_feat)
        network.add(layers.Dense(units = 2**hidden, activation = activ_func, input_shape=(l_feat,), kernel_regularizer=regularizers.L1L2(l1 = regL1L2, l2 = regL1L2)))
        for h in range(1, hidden):
            network.add(layers.Dense(units = 2**(hidden - h), activation = activ_func, kernel_regularizer=regularizers.L1L2(l1 = regL1L2, l2 = regL1L2)))   
        network.add(layers.Dense(units=1, activation = 'linear'))
        network.compile(loss=loss_func, optimizer= keras.optimizers.Adam(0.005, decay = 0.005), metrics=['mean_squared_error']) 
        history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = hidden * 100,batch_size = 50, validation_split = 0.1)
        if iteration == Number_measure - 1:
            plot_loss(history, string_l = "NN Adam MAE" + str(hidden), draw_val = True)
            ann_viz(network, view = True, filename = "fig_NN/NN_triangle_" + str(hidden) + ".gv", title="NN")
        MSE_Train[iteration] = mean_s_error(y_train,network.predict(X_train_scaled_poly).flatten())    
        MAPE_Train[iteration] = mean_absolute_percentage_error(y_train,network.predict(X_train_scaled_poly).flatten())
        MSE_Test[iteration] = mean_s_error(y_test,network.predict(X_test_scaled_poly).flatten())    
        MAPE_Test[iteration] = mean_absolute_percentage_error(y_test,network.predict(X_test_scaled_poly).flatten())
...
axis[0].set_title("MSE, Hidden_Tanh triangle, L1L2 = 0.1")
axis[0].legend(loc="best")
...
axis[1].set_title("MAPE, Hidden_Tanh triangle, L1L2 = 0.1")
axis[1].legend(loc="best")
...
axis[0].plot(List_Hidden, List_MSE_L1_Min, linewidth=0.75, color = "red")
axis[0].plot(List_Hidden, List_MSE_L1_Max, linewidth=0.75, color = "red")
axis[0].plot(List_Hidden, List_MSE_L1_Mean, label="L1Reg_mean", linewidth=2.0, color = "red")

axis[0].plot(List_Hidden, List_MSE_L2_Min, linewidth=0.75, color = "green")
axis[0].plot(List_Hidden, List_MSE_L2_Max, linewidth=0.75, color = "green")
axis[0].plot(List_Hidden, List_MSE_L2_Mean, label="L2Reg_mean", linewidth=2.0, color = "green")

axis[0].plot(List_Hidden, List_MSE_L1L2_Min, linewidth=0.75, color = "blue")
axis[0].plot(List_Hidden, List_MSE_L1L2_Max, linewidth=0.75, color = "blue")
axis[0].plot(List_Hidden, List_MSE_L1L2_Mean, label="L1L2Reg_mean", linewidth=2.0, color = "blue")


axis[0].set_title("MSE, Hidden_Tanh triangle")
axis[0].legend(loc="best")
...
axis[1].plot(List_Hidden, List_MAPE_L1_Min, linewidth=0.75, color = "red")
axis[1].plot(List_Hidden, List_MAPE_L1_Max, linewidth=0.75, color = "red")
axis[1].plot(List_Hidden, List_MAPE_L1_Mean, label="L1Reg_mean", linewidth=2.0, color = "red")

axis[1].plot(List_Hidden, List_MAPE_L2_Min, linewidth=0.75, color = "green")
axis[1].plot(List_Hidden, List_MAPE_L2_Max, linewidth=0.75, color = "green")
axis[1].plot(List_Hidden, List_MAPE_L2_Mean, label="L2Reg_mean", linewidth=2.0, color = "green")

axis[1].plot(List_Hidden, List_MAPE_L1L2_Min, linewidth=0.75, color = "blue")
axis[1].plot(List_Hidden, List_MAPE_L1L2_Max, linewidth=0.75, color = "blue")
axis[1].plot(List_Hidden, List_MAPE_L1L2_Mean, label="L1L2Reg_mean", linewidth=2.0, color = "blue")

axis[1].set_title("MAPE, Hidden_Tanh triangle")
axis[1].legend(loc="best")
...
axis[0].set_title("MSE, Hidden_Tanh triangle, Mean")
axis[0].legend(loc="best")
...
axis[1].set_title("MAPE, Hidden_Tanh triangle, Mean")
axis[1].legend(loc="best")
...
axis[0].plot(List_Hidden, List_MSE_non_Min, label="NonReg_Min", linewidth=2.0, color = "black")
axis[0].plot(List_Hidden, List_MSE_L1_Min, label="L1Reg_Min", linewidth=2.0, color = "red")
axis[0].plot(List_Hidden, List_MSE_L2_Min, label="L2Reg_Min", linewidth=2.0, color = "green")
axis[0].plot(List_Hidden, List_MSE_L1L2_Min, label="L1L2Reg_Min", linewidth=2.0, color = "blue")

axis[0].set_title("MSE, Hidden_Tanh triangle, Min")
axis[0].legend(loc="best")

axis[1].plot(List_Hidden, List_MAPE_non_Min, label="NonReg_Min", linewidth=2.0, color = "black")
axis[1].plot(List_Hidden, List_MAPE_L1_Min, label="L1Reg_Min", linewidth=2.0, color = "red")
axis[1].plot(List_Hidden, List_MAPE_L2_Min, label="L2Reg_Min", linewidth=2.0, color = "green")
axis[1].plot(List_Hidden, List_MAPE_L1L2_Min, label="L1L2Reg_Min", linewidth=2.0, color = "blue")

axis[1].set_title("MAPE, Hidden_Tanh triangle, Min")
axis[1].legend(loc="best")
...
#             network.add(layers.Dense(units = 10, activation = activ_func))   
#         network.add(layers.Dense(units=1, activation = 'linear'))
#         network.compile(loss=loss_func, optimizer= keras.optimizers.Adam(0.005, decay = 0.005), metrics=['mean_squared_error']) 
#         history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = hidden*200,batch_size = 50, validation_split = 0.1)
#         if iteration == Number_measure - 1:
#             plot_loss(history, string_l = "NN Adam MAE" + str(hidden), draw_val = True)
#         MSE_Train[iteration] = mean_s_error(y_train,network.predict(X_train_scaled_poly).flatten())    
#         MAPE_Train[iteration] = mean_absolute_percentage_error(y_train,network.predict(X_train_scaled_poly).flatten())
...
#         l_feat = X_train_scaled_poly.shape[1]
#         # print(iteration, l_feat)
#         network.add(layers.Dense(units = 10, activation = activ_func, input_shape=(l_feat,), kernel_regularizer=regularizers.L1(regL1)))
#         for h in range(hidden - 1):
#             network.add(layers.Dense(units = 10, activation = activ_func, kernel_regularizer=regularizers.L1(regL1)))   
#         network.add(layers.Dense(units=1, activation = 'linear'))
#         network.compile(loss=loss_func, optimizer= keras.optimizers.Adam(0.005, decay = 0.005), metrics=['mean_squared_error']) 
#         history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = hidden * 200,batch_size = 50, validation_split = 0.1)
#         if iteration == Number_measure - 1:
...
# axis[0].set_title("MSE, Hidden_sigmoid 10, L1 = 0.01")
# axis[0].legend(loc="best")
...
# axis[1].set_title("MAPE, Hidden_sigmoid 10, L1 = 0.01")
# axis[1].legend(loc="best")
...
#         l_feat = X_train_scaled_poly.shape[1]
#         # print(iteration, l_feat)
#         network.add(layers.Dense(units = 10, activation = activ_func, input_shape=(l_feat,), kernel_regularizer=regularizers.L2(regL2)))
#         for h in range(hidden - 1):
#             network.add(layers.Dense(units = 10, activation = activ_func, kernel_regularizer=regularizers.L2(regL2)))   
#         network.add(layers.Dense(units=1, activation = 'linear'))
#         network.compile(loss=loss_func, optimizer= keras.optimizers.Adam(0.005, decay = 0.005), metrics=['mean_squared_error']) 
#         history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = hidden * 200,batch_size = 50, validation_split = 0.1)
#         if iteration == Number_measure - 1:
...
# axis[0].set_title("MSE, Hidden_sigmoid 10, L2 = 0.01")
# axis[0].legend(loc="best")
...
# axis[1].set_title("MAPE, Hidden_sigmoid 10, L2 = 0.01")
# axis[1].legend(loc="best")
...
#         l_feat = X_train_scaled_poly.shape[1]
#         # print(iteration, l_feat)
#         network.add(layers.Dense(units = 10, activation = activ_func, input_shape=(l_feat,), kernel_regularizer=regularizers.L1L2(l1 = regL1L2, l2 = regL1L2)))
#         for h in range(hidden - 1):
#             network.add(layers.Dense(units = 10, activation = activ_func, kernel_regularizer=regularizers.L1L2(l1 = regL1L2, l2 = regL1L2)))   
#         network.add(layers.Dense(units=1, activation = 'linear'))
#         network.compile(loss=loss_func, optimizer= keras.optimizers.Adam(0.005, decay = 0.005), metrics=['mean_squared_error']) 
#         history = network.fit(X_train_scaled_poly, y_train, verbose=0, epochs = hidden * 200,batch_size = 50, validation_split = 0.1)
#         if iteration == Number_measure - 1:
#             plot_loss(history, string_l = "NN Adam MAE" + str(hidden), draw_val = True)
#             # ann_viz(network, view = True, filename = "fig_NN/NN_box_5_" + str(hidden) + ".gv", title="NN")
#         MSE_Train[iteration] = mean_s_error(y_train,network.predict(X_train_scaled_poly).flatten())    
#         MAPE_Train[iteration] = mean_absolute_percentage_error(y_train,network.predict(X_train_scaled_poly).flatten())
#         MSE_Test[iteration] = mean_s_error(y_test,network.predict(X_test_scaled_poly).flatten())    
#         MAPE_Test[iteration] = mean_absolute_percentage_error(y_test,network.predict(X_test_scaled_poly).flatten())
...
# axis[0].set_title("MSE, Hidden_sigmoid 10, L1L2 = 0.01")
# axis[0].legend(loc="best")
...
# axis[1].set_title("MAPE, Hidden_sigmoid 10, L1L2 = 0.01")
# axis[1].legend(loc="best")
