...
for column in feat_float_src:
	df_src[column] = df_src[column].diff() 
...
plt.savefig('data_diff_fig/density_src.png')
# plt.show()
...
plt.savefig('data_diff_fig/violin_src.png')
...
sns.heatmap(c_m_pear)
plt.savefig('data_diff_fig/corr_pear_src.png')

plt.subplots(sharey = True, figsize = (12, 10))
c_m_kend = df_src[feat_float_src].corr(method='kendall')
sns.heatmap(c_m_kend)
plt.savefig('data_diff_fig/corr_kend_src.png')

plt.subplots(sharey = True, figsize = (12, 10))
c_m_spea = df_src[feat_float_src].corr(method='spearman')
sns.heatmap(c_m_spea)
plt.savefig('data_diff_fig/corr_spea_src.png')
...
plt.savefig('data_diff_fig/corr_Scatterplot_src.png')
